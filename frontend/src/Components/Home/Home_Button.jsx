...
export function Home_Button(){
    const Logo = (<svg width="70px" height="70px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
return <div className="w-[80%] h-24 flex text-slate-50 rounded-xl bg-green-600 gap-4 cursor-pointer">
            <div className="w-[20%] flex justify-center p-2">
                {Logo}
            </div>
            <div className="w-[80%] h-full flex flex-col justify-center gap-1">
